...
function buildRatingExplainAbout() {
    ...
    return [
        ...
        '| Axis | Weight | What it measures |',
        '| --- | ---: | --- |',
        '| Return Effectiveness | 30% | Of returns on tasks that stayed on a shippable path (production, bugged, or escalated), how often the task reached production. Discarded and dismissed tasks are excluded. |',
