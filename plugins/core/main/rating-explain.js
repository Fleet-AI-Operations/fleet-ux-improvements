...
function buildRatingExplainAbout() {
    ...
    return [
        ...
        '| Label Discrimination | 10% | Top/Bottom label usage vs an ideal ~20% rate (full credit at 20%; falls toward 0 at 0% and at 40%+). Omitted when fewer than 10 feedback rows are in scope. |',
