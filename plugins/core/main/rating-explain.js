...
function buildRatingExplainAbout() {
    ...
    return [
        ...
        '## Population tier',
        '',
        'The **primary display** is a population tier label (Poor, Below average, Typical, Above average, Top tier), with an **estimated percentile** shown beside it (for example, ~62nd). The headline also shows the previous-population overall percentile in parentheses (for example, ~37th (old: ~61st)). Team, environment, and month subset rows show the current percentile only.',
        '',
