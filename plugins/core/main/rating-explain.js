...
const RATING_EXPLAIN_ABOUT = [
    ...
    '| Top tier | ≥ 70 | ≥ 70 |',
    '',
    'Extreme labels are soft-gated on volume:',
    '',
    '- **Top tier** needs TWQS ≥ 50 terminal tasks or QAQS ≥ 100 feedback rows; otherwise it displays as Above average.',
    '- **Poor** needs TWQS ≥ 25 terminal tasks or QAQS ≥ 50 feedback rows; otherwise it displays as Below average.',
    ...
    '- When an extreme tier is soft-gated for volume, a **Volume-gated tier** badge gives the score-qualified tier, displayed tier, and current versus required volume. The estimated percentile is never changed by this gate.',
    '',
    ...
    '- `tierGate` means an extreme tier was volume-demoted. When it is null or absent, do not speculate about gating.',
...
const plugin = {
    ...
    init(state) {
        ...
        Logger.log(PLUGIN_ID + ': module registered (Context.ratingExplain) v1.4');
    }
};
