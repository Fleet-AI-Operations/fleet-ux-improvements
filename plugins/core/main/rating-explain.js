...
function buildRatingExplainAbout() {
    ...
    return [
        ...
        '| V1 Creation Time | 20% | Average platform-tracked v1 creation time. Full credit from 15 to 60 minutes; the score falls toward zero as the average approaches 0 or 150 minutes. Toggleable. |',
        ...
        '| QA Time | 20% | Average platform-tracked QA review time. Full credit from 15 to 60 minutes; the score falls toward zero as the average approaches 0 or 150 minutes. Toggleable. |',
