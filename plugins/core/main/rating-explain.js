...
function buildRatingExplainAbout() {
    ...
    return [
        ...
        '| --- | ---: | --- |',
        '| Outcome Quality | 35% | Blend of current terminal quality and flat closure quality: production 1.0, discarded 0.5, dismissed 0.0. Closure excludes bugged/flagged paths. |',
        ...
        '| Positive Feedback Rate | 15% | Share of human feedback on their tasks that was positive (upvote or score ≥ Satisfactory). Self-reviews excluded. |',
        ...
        '| Revision Efficiency | 10% | On terminal tasks with version history: full credit at one display version; each extra version halves credit (0.5^(v−1)). Upheld writer disputes do not count against the version total. |',
        '| Dispute Loss Avoidance | 10% | Rejected writer disputes as a rate vs tasks they authored. Full credit at zero losses; the score falls toward zero as losses approach 10% of tasks. Approved disputes are neutral. |',
        '',
