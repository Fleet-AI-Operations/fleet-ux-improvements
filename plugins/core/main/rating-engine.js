...
const RE_TIER_THRESHOLDS = {
    ...
    qaqs: {
        flat:         { p10: 63.954, p30: 68.56, p70: 74.418, topMin: 74.428 },
        recency:      { p10: 66.46, p30: 70.2, p70: 74.74, topMin: 74.75 },
        flatNoTime:   { p10: 62.694, p30: 67.724, p70: 74.184, topMin: 74.194 },
        recencyNoTime:{ p10: 65.186, p30: 69.318, p70: 74.266, topMin: 74.276 },
    },
};
...
// Snapshot: 665 WPS / 249 QPS population; flat + recency30d (engine 14.0 cohort time cutoffs).
const RE_PERCENTILE_PARAMS = {
    ...
    qaqs: {
        flat:         { mu: 71.3371, sigma: 5.7662 },
        recency:      { mu: 72.1502, sigma: 4.2300 },
        flatNoTime:   { mu: 70.8018, sigma: 6.5469 },
        recencyNoTime:{ mu: 71.5270, sigma: 4.9883 },
    },
};
...
const RatingEngine = {
    ...
    _computeQaqs(workerId, hydratedItems, weighting, window, nowMs, cohort, includeTime, baselines) {
        ...
        // Return Effectiveness: neg feedback on shippable-path tasks → production
        ...
        for (const { entry, task } of feedbackRows) {
            ...
            // Return Effectiveness: neg feedback on shippable-path statuses only
            // (discarded/dismissed task deaths are excluded from the denominator).
            if (!entry.isPositive && RE_QAQS_RET_EFF_DENOM_STATUSES[taskStatus]) {
                reNsum += fw;
                reEligibleCount += 1;
