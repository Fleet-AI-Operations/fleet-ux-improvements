...
const RE_TWQS_PRIOR = {
    outcomeQuality:       0.7943,
    positiveFeedbackRate: 0.4593,
    nonBottomScoreRate:   0.9524,
    firstPassAcceptance:  0.4336,
...
const RE_QAQS_RET_EFF_PRIOR     = 0.5218;
const RE_QAQS_RET_ACT_C         = 10;
const RE_QAQS_RET_ACT_PRIOR     = 0.6850;
...
// Snapshot: 1316 WPS / 285 QPS / 1303 combined; flat + recency30d (2026-07-14).
...
const RE_TIER_THRESHOLDS = {
    twqs: {
        flat:    { p10: 62.38, p30: 68.185, p70: 75.315, topMin: 80 },
        recency: { p10: 66.665, p30: 70.96, p70: 74.27, topMin: 80 },
    },
    qaqs: {
        flat:    { p10: 49.228, p30: 54.692, p70: 60.89, topMin: 70 },
        recency: { p10: 49.158, p30: 54.592, p70: 60.378, topMin: 70 },
    },
    combined: {
        flat:    { p10: 58.862, p30: 66.13, p70: 73.01, topMin: 78.466 },
        recency: { p10: 61.43, p30: 69.136, p70: 73.604, topMin: 76.608 },
    },
};
...
// Snapshot: 1316 WPS / 285 QPS; flat + recency30d (2026-07-14).
const RE_PERCENTILE_PARAMS = {
    twqs: {
        flat:    { mu: 71.2721, sigma: 7.0185 },
        recency: { mu: 72.5427, sigma: 4.9800 },
    },
    qaqs: {
        flat:    { mu: 57.5310, sigma: 6.4085 },
        recency: { mu: 57.0606, sigma: 6.0786 },
    },
};
