...
// Engine v15.0: Return Effectiveness counts ordinary returns only.

const RE_VERSION = '15.0';
...
const RE_TWQS_AXES = [
    ...
    { id: 'firstPassAcceptance',  label: 'First-Pass Acceptance',  weight: 0.10 },
...
// Snapshot: 1030 WPS / 285 QPS; flat + recency30d (engine 13.0 Time axes, dual Time/No Time).
...
const RE_TIER_THRESHOLDS = {
    twqs: {
        flat:         { p10: 62.114, p30: 67.964, p70: 74.878, topMin: 80 },
        recency:      { p10: 66.772, p30: 70.394, p70: 73.598, topMin: 80 },
        flatNoTime:   { p10: 60.544, p30: 66.89, p70: 74.648, topMin: 80 },
        recencyNoTime:{ p10: 65.424, p30: 69.512, p70: 73.158, topMin: 80 },
    },
    qaqs: {
        flat:         { p10: 68.836, p30: 73.392, p70: 78.242, topMin: 78.252 },
        recency:      { p10: 71.598, p30: 74.822, p70: 78.988, topMin: 78.998 },
        flatNoTime:   { p10: 68.946, p30: 73.384, p70: 78.92, topMin: 78.93 },
        recencyNoTime:{ p10: 72.012, p30: 74.562, p70: 79.772, topMin: 79.782 },
    },
};
...
// Snapshot: 665 WPS / 249 QPS population; flat + recency30d (engine 15.0 RE ordinary returns).
const RE_PERCENTILE_PARAMS = {
    twqs: {
        flat:         { mu: 70.9517, sigma: 6.7390 },
        recency:      { mu: 71.8860, sigma: 4.1766 },
        flatNoTime:   { mu: 70.2785, sigma: 7.6725 },
        recencyNoTime:{ mu: 71.1353, sigma: 4.8077 },
    },
    qaqs: {
        flat:         { mu: 75.6827, sigma: 5.0212 },
        recency:      { mu: 76.7039, sigma: 3.7689 },
        flatNoTime:   { mu: 76.1976, sigma: 5.4869 },
        recencyNoTime:{ mu: 77.1975, sigma: 4.2922 },
    },
};
