...
// Engine v15.1: population recalibration after dismissed-list update (RE ordinary returns only).

const RE_VERSION = '15.1';
...
// Snapshot: 638 WPS / 242 QPS population; flat + recency30d (engine 15.1 dismissed-list recalc).
...
const RE_TIER_THRESHOLDS = {
    twqs: {
        flat:         { p10: 62.197, p30: 68.129, p70: 74.955, topMin: 80 },
        recency:      { p10: 66.797, p30: 70.541, p70: 73.649, topMin: 80 },
        flatNoTime:   { p10: 60.522, p30: 67.017, p70: 74.861, topMin: 80 },
        recencyNoTime:{ p10: 65.606, p30: 69.652, p70: 73.208, topMin: 80 },
    },
    qaqs: {
...
const RE_PERCENTILE_PARAMS = {
    twqs: {
        flat:         { mu: 71.0476, sigma: 6.7711 },
        recency:      { mu: 71.9871, sigma: 4.1577 },
        flatNoTime:   { mu: 70.3720, sigma: 7.7370 },
        recencyNoTime:{ mu: 71.2479, sigma: 4.8007 },
    },
    qaqs: {
