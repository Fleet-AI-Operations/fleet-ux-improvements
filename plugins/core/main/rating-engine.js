...
// Engine v12.3: Acceptance Scrutiny two-sided 40–60% full-credit trapezoid.

const RE_VERSION = '12.3';
...
// Snapshot: 1030 WPS / 285 QPS; flat + recency30d (engine 12.3 AS 40–60% trapezoid).
...
const RE_TIER_THRESHOLDS = {
    ...
    qaqs: {
        flat:    { p10: 58.014, p30: 64.376, p70: 72.028, topMin: 72.038 },
        recency: { p10: 58.744, p30: 65.57, p70: 72.568, topMin: 72.578 },
    },
};
...
const RE_PERCENTILE_PARAMS = {
    ...
    qaqs: {
        flat:    { mu: 67.8378, sigma: 7.7054 },
        recency: { mu: 68.5678, sigma: 6.6046 },
    },
};
