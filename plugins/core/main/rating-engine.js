...
// Snapshot: 1316 WPS / 285 QPS / 1303 combined; flat + recency30d (Task Rating Quality).
...
const RE_TIER_THRESHOLDS = {
    ...
    combined: {
        flat:    { p10: 54.272, p30: 59.95, p70: 66.784, topMin: 71.932 },
        recency: { p10: 57.14, p30: 63.12, p70: 66.94, topMin: 70.116 },
    },
};

// Parametric percentile distributions (μ, σ) fitted from current dive.db scores.
// Estimated percentile (exports only) = bottom + (100 − bottom − top) × Φ((score − μ) / σ)
