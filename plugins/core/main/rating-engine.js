...
// Engine v11.1: recalibrated tiers/percentiles after Data Engineering cohort ingest.

const RE_VERSION = '11.1';
...
// Snapshot: 1316 WPS / 286 QPS; flat + recency30d (includes data-eng).
...
const RE_TIER_THRESHOLDS = {
    twqs: {
        flat:    { p10: 55.675, p30: 61.38, p70: 68.56, topMin: 80 },
        recency: { p10: 60.165, p30: 64.37, p70: 67.525, topMin: 80 },
    },
    qaqs: {
        flat:    { p10: 49.07, p30: 54.33, p70: 60.6, topMin: 70 },
        recency: { p10: 49.14, p30: 54.145, p70: 59.845, topMin: 70 },
    },
};
...
const RE_PERCENTILE_PARAMS = {
    twqs: {
        flat:    { mu: 64.5292, sigma: 6.8851 },
        recency: { mu: 65.8553, sigma: 4.7277 },
    },
    qaqs: {
        flat:    { mu: 57.1571, sigma: 6.2163 },
        recency: { mu: 56.5969, sigma: 5.7042 },
    },
};
