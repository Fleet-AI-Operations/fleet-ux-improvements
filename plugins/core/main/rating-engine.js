...
// Engine v12.0: Acceptance Scrutiny, RE denominator, DD feedbackId attribution,
// LD usage-rate, headline = main score, weight retune.

const RE_VERSION = '12.0';
...
// Snapshot: 1030 WPS / 285 QPS; flat + recency30d (engine 12.0 formula retune).
...
const RE_TIER_THRESHOLDS = {
    ...
    qaqs: {
        flat:    { p10: 56.32, p30: 60.65, p70: 66.91, topMin: 70 },
        recency: { p10: 56.238, p30: 60.99, p70: 66.168, topMin: 70 },
    },
};
...
const RE_PERCENTILE_PARAMS = {
    ...
    qaqs: {
        flat:    { mu: 63.6521, sigma: 5.9615 },
        recency: { mu: 63.0506, sigma: 4.8727 },
    },
};
