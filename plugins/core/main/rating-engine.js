...
// Engine v12.5: TW+QA Dispute Loss Avoidance shared loss-rate curve (L/(T+C), zero at 10%).

const RE_VERSION = '12.5';
...
const RE_TWQS_AXES = [
    { id: 'outcomeQuality',       label: 'Outcome Quality',        weight: 0.45 },
...
// Snapshot: 1030 WPS / 285 QPS; flat + recency30d (engine 12.5 TW+QA DD loss-rate).
...
const RE_TIER_THRESHOLDS = {
    twqs: {
        flat:    { p10: 55.748, p30: 63.451, p70: 71.646, topMin: 80 },
        recency: { p10: 62.483, p30: 66.36, p70: 70.093, topMin: 80 },
    },
    qaqs: {
        flat:    { p10: 60.84, p30: 66.25, p70: 72.77, topMin: 72.78 },
        recency: { p10: 62.894, p30: 67.936, p70: 73.386, topMin: 73.396 },
    },
};
...
const RE_PERCENTILE_PARAMS = {
    twqs: {
        flat:    { mu: 66.8270, sigma: 8.4135 },
        recency: { mu: 68.1782, sigma: 4.9665 },
    },
    qaqs: {
        flat:    { mu: 69.3440, sigma: 7.0910 },
        recency: { mu: 70.0742, sigma: 5.4331 },
    },
};
...
const RatingEngine = {
    ...
    // Computes QPS-aligned QAQS (five-axis, rank-qa.py v3 formula).
