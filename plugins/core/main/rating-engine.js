...
// refreshed 2026-08-25 (Aug 19–25 ingest). Frozen previous percentile is separate.
...
const RE_TIER_THRESHOLDS = {
    twqs: {
        flat:         { p10: 67.894, p30: 72.094, p70: 77.663, topMin: 80 },
        recency:      { p10: 70.597, p30: 73.791, p70: 76.27, topMin: 80 },
        flatNoTime:   { p10: 67.676, p30: 72.706, p70: 77.969, topMin: 80 },
        recencyNoTime:{ p10: 70.799, p30: 73.931, p70: 76.742, topMin: 80 },
    },
    qaqs: {
        ...
        recencyNoTime:{ p10: 71.905, p30: 75.015, p70: 79.275, topMin: 79.285 },
    },
};
...
// Snapshot: 388 WPS / 186 QPS; remaining population after 2026-08-24 mass dismissal,
// refreshed 2026-08-25 (Aug 19–25 ingest).
const RE_PERCENTILE_PARAMS = {
    twqs: {
        flat:         { mu: 74.3872, sigma: 5.444 },
        recency:      { mu: 74.9493, sigma: 3.38 },
        flatNoTime:   { mu: 74.6961, sigma: 5.7455 },
        recencyNoTime:{ mu: 75.0814, sigma: 3.6971 },
    },
    qaqs: {
        flat:         { mu: 75.4403, sigma: 5.0209 },
        recency:      { mu: 76.4959, sigma: 4.2432 },
        flatNoTime:   { mu: 75.7616, sigma: 5.1774 },
        recencyNoTime:{ mu: 76.9694, sigma: 4.5963 },
    },
};
