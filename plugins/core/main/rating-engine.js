...
// Snapshot: 635 WPS / 246 QPS; TRQ blank=Average (engine 17.0, 2026-08-19).
...
const RE_TIER_THRESHOLDS = {
    twqs: {
        flat:         { p10: 66.816, p30: 71.304, p70: 77.058, topMin: 80 },
        recency:      { p10: 70.038, p30: 73.3, p70: 76.1, topMin: 80 },
        flatNoTime:   { p10: 66.21, p30: 71.622, p70: 77.224, topMin: 80 },
        recencyNoTime:{ p10: 69.026, p30: 73.142, p70: 76.124, topMin: 80 },
    },
    qaqs: {
        flat:         { p10: 69.43, p30: 73.615, p70: 78.21, topMin: 78.22 },
        recency:      { p10: 71.73, p30: 74.995, p70: 79.105, topMin: 79.115 },
        flatNoTime:   { p10: 68.81, p30: 73.765, p70: 79.12, topMin: 79.13 },
        recencyNoTime:{ p10: 71.285, p30: 74.79, p70: 79.92, topMin: 79.93 },
    },
};
...
const RE_PERCENTILE_PARAMS = {
    twqs: {
        flat:         { mu: 73.8937, sigma: 5.3974 },
        recency:      { mu: 74.5319, sigma: 3.6017 },
        flatNoTime:   { mu: 73.8477, sigma: 5.8891 },
        recencyNoTime:{ mu: 74.3637, sigma: 3.9984 },
    },
    qaqs: {
        flat:         { mu: 75.6165, sigma: 5.3183 },
        recency:      { mu: 76.5907, sigma: 4.3198 },
        flatNoTime:   { mu: 76.1087, sigma: 5.808 },
        recencyNoTime:{ mu: 77.1548, sigma: 4.8132 },
    },
};
