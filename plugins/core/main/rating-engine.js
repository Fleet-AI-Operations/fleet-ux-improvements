...
// Snapshot: 638 WPS / 246 QPS; flat + recency30d after 2026-08-19 ingest (Jul 31–Aug 19).
...
const RE_TIER_THRESHOLDS = {
    twqs: {
        flat:         { p10: 66.707, p30: 72.335, p70: 78.276, topMin: 80 },
        recency:      { p10: 70.632, p30: 74.121, p70: 76.94, topMin: 80 },
        flatNoTime:   { p10: 66.323, p30: 72.3, p70: 78.81, topMin: 80 },
        recencyNoTime:{ p10: 69.925, p30: 74.161, p70: 77.32, topMin: 80 },
    },
    qaqs: {
        flat:         { p10: 69.43, p30: 73.615, p70: 78.21, topMin: 78.22 },
        recency:      { p10: 71.71, p30: 74.985, p70: 79.105, topMin: 79.115 },
...
const RE_PERCENTILE_PARAMS = {
    twqs: {
        flat:         { mu: 74.7051, sigma: 6.0594 },
        recency:      { mu: 75.4495, sigma: 3.8596 },
        flatNoTime:   { mu: 74.8561, sigma: 6.7843 },
        recencyNoTime:{ mu: 75.506, sigma: 4.3313 },
    },
    qaqs: {
        flat:         { mu: 75.6165, sigma: 5.3183 },
        recency:      { mu: 76.5862, sigma: 4.3253 },
        flatNoTime:   { mu: 76.1087, sigma: 5.808 },
        recencyNoTime:{ mu: 77.1502, sigma: 4.8186 },
    },
};
