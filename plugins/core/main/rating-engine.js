...
// Engine v11.4: recalibrated tiers/percentiles after Jul 21–31 CU window ingest.

const RE_VERSION = '11.4';
...
// Snapshot: 1030 WPS / 285 QPS; flat + recency30d (after Jul 21–31 CU window ingest).
...
const RE_TIER_THRESHOLDS = {
    twqs: {
        flat:    { p10: 53.868, p30: 60.944, p70: 68.373, topMin: 80 },
        recency: { p10: 59.649, p30: 63.597, p70: 67.096, topMin: 80 },
    },
    qaqs: {
        flat:    { p10: 47.844, p30: 53.982, p70: 60.022, topMin: 70 },
        recency: { p10: 48.282, p30: 53.846, p70: 59.728, topMin: 70 },
    },
};
...
const RE_PERCENTILE_PARAMS = {
    twqs: {
        flat:    { mu: 63.9583, sigma: 7.3789 },
        recency: { mu: 65.2017, sigma: 4.6935 },
    },
    qaqs: {
        flat:    { mu: 56.6838, sigma: 6.2772 },
        recency: { mu: 56.1646, sigma: 5.4395 },
    },
};
