...
function fleetUiBtnBaseCssLines(scopePrefix) {
    ...
    return [
        ...
        '  border: none;',
        '  background: color-mix(in srgb, var(--foreground, #0f172a) 8%, transparent);',
        '}',
        tertiary + '.wf-dash-btn--icon:hover:not(:disabled) {',
        '  background: color-mix(in srgb, var(--foreground, #0f172a) 14%, transparent);',
        '  border: none;',
        '  color: var(--foreground, #0f172a);',
        '}',
        ...
        '  border: none;',
        '  background: color-mix(in srgb, #000000 7%, transparent);',
        '  color: #666666;',
        '}',
