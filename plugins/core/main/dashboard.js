...
const plugin = {
    ...
    _createInitialState() {
        return {
            ...
            resolvedDisputesPrefetchStarted: false,
            resolvedDisputesPrefetchStatus: 'idle',
            resolvedDisputesPrefetchPromise: null,
            resolvedDisputesByTaskId: null,
            resolvedDisputesBulkIncomplete: false,
    ...
    _ensureMsOptionStyles() {
        ...
        style.textContent = [
            ...
            '}',
            '#wf-dash-left-panel-filters > div [data-wf-dash-ms-wrap][data-wf-dash-ms-flyout="1"][data-wf-dash-ms-toggled="1"][data-wf-dash-ms-open="1"] [data-wf-dash-ms-sticky] {',
            '  top: 0;',
            '}',
