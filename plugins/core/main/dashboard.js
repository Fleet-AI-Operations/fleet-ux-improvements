...
const plugin = {
    ...
    _ensureUserStoryStyles() {
        ...
        style.textContent = [
            ...
            '  color: var(--muted-foreground, #64748b);',
            '}',
            '#wf-dash-modal .wf-dash-session-qa-inline-msg {',
            '  margin: 0;',
            '  line-height: 1.45;',
            '  font-size: 12px;',
            '  font-family: inherit;',
            '  color: var(--muted-foreground, #64748b);',
            '}',
            '#wf-dash-modal .wf-dash-verifier-output-inline-msg {',
            '  margin: 0;',
            '  line-height: 1.45;',
            '  font-size: 12px;',
            '  font-family: inherit;',
    ...
    _ensureCardActionStyles() {
        ...
        const css = [
            ...
            '  padding: 0 8px;',
            '}',
            '#wf-dash-modal .wf-dash-card-action--attempt-rescue {',
            '  width: auto;',
            '  min-width: 0;',
            ...
            '}',
            '#wf-dash-modal .wf-dash-card-action--attempt-rescue:hover {',
            '  background: #78350f;',
            '  border-color: #92400e;',
            '  color: #fff7ed;',
            '}',
            '#wf-dash-modal .wf-dash-card-action--rehydrate:disabled,',
            '#wf-dash-modal .wf-dash-card-action--attempt-rescue:disabled {',
            '  opacity: 0.65;',
            '  cursor: wait;',
            '}',
