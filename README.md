...
### Dispute Review Page
- **Dispute List Collapse**: Replaces the native expand control with a full collapse toggle that hides everything except the status/time/#id header row; remembers closed dispute numbers across reloads
