...
// ==UserScript==
// @name         [feat-dispute-verifier-diff] Fleet Workflow Builder UX Enhancer
...
// @downloadURL  https://raw.githubusercontent.com/fleet-ai-operations/fleet-ux-improvements/feat-dispute-verifier-diff/fleet.user.js
// @updateURL    https://raw.githubusercontent.com/fleet-ai-operations/fleet-ux-improvements/feat-dispute-verifier-diff/fleet.user.js
// ==/UserScript==
...
(function() {
    ...
    const GITHUB_CONFIG = {
        ...
        branch: 'feat-dispute-verifier-diff',
        pluginsPath: 'plugins',
        corePath: 'core',
        devPath: 'dev',
