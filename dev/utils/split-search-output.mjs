...
const RESULTS_METHODS = new Set([
    ...
    '_userStoryEmptyMessage', '_userStoryHasContent', '_userStoryIsAbsent', '_userStoryEmptyHtml',
    '_userStoryReady', '_userStoryActionBlockId', '_userStoryTitle', '_userStoryBodyPortions',
    '_userStoryPanelBodyHtml', '_userStoryBlockHtml',
    '_userStoryBtnLabel', '_sessionQaIsAbsent', '_sessionQaBtnDisabled', '_verifierOutputIsAbsent', '_verifierOutputBtnDisabled',
    '_supplementalControlsHtml', '_supplementalPanelsHtml', '_supplementalSectionHtml',
    '_findSupplementalSection', '_findSupplementalPanels', '_findUserStorySection',
    '_animateSupplementalPanelOpen', '_animateUserStoryOpen', '_syncUserStoryPanelOpen',
    ...
    '_quotedFieldBodyLayoutStyle', '_mutedQuotedFieldBodyStyle', '_quotedBarButtonHtml', '_quotedBarWrapHtml', '_quotedFieldBlockHtml',
    '_quotedHighlightFromItem', '_quotedHighlightForItemId', '_quotedHighlightPack', '_quotedTextMatches', '_expandBlockForHighlight',
    '_quotedFilledPortions', '_quotedPortionPlainText', '_quotedPortionsPlainText', '_quotedPortionsHtml',
    '_qaFeedbackPortions', '_userStoryPortionBlockId', '_userStoryPortions', '_promptTextActionBlockId', '_versionBodyPortions',
    ...
    '_detachCardRollingListeners', '_clearAllRollingOverlayListeners', '_ensureSharedRollingResultsListener',
    '_teardownSharedRollingResultsListener', '_teardownSharedRollingResultsListenerIfIdle',
    '_scheduleRollingOverlaysFlush', '_flushRollingOverlays',
    '_removeCardRollingOverlay', '_updateCardRollingOverlay', '_attachCardRollingListeners',
    ...
    '_renderResults', '_dashCopyInnerHtml', '_copyChipHtml', '_copyIconHtml', '_liveSectionCopyIconHtml', '_findItemQaDisplay', '_promptVersionStatusLabel', '_resolvePromptVersionCopyText', '_resolveLiveSectionCopyText', '_promptVersionHeadLine', '_extLinkIconSvg', '_extLinkHtml', '_extLinkButtonStyle', '_taskOpenLinkHtml',
    '_labelSpan', '_promptVersionCountHtml', '_collapsedVersionPickerHtml', '_expandedVersionHeaderHtml', '_fieldGroupHtml',
    '_notesToQaActionBlockId', '_scratchpadActionBlockId', '_plainTimestampHtml', '_dashHighlightSegmentsHtml', '_dashSplitMarkdownLinkParts', '_dashHighlightedHtml',
